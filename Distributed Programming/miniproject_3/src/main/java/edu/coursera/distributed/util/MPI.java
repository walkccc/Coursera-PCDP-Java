...
public final class MPI {
  private interface MPILib extends Library {
    ...
    int MPI_Recv(DoubleBuffer buf, int count, Pointer datatype, int src, int tag, Pointer comm,
        Pointer status);
   ...
   * @throws MPIException On MPI error
   */
  public void MPI_Bcast(final double[] buf, final int offset, final int count, final int root,
      final MPI_Comm comm) throws MPIException {
   ...
   * @throws MPIException On MPI error
   */
  public void MPI_Send(final int[] buf, final int offset, final int count, final int dst,
      final int tag, final MPI_Comm comm) throws MPIException {
   ...
   * @throws MPIException On MPI error
   */
  public void MPI_Send(final double[] buf, final int offset, final int count, final int dst,
      final int tag, final MPI_Comm comm) throws MPIException {
    final DoubleBuffer wrapper = DoubleBuffer.wrap(buf, offset, count);
    final int err =
   ...
   * @throws MPIException On MPI error
   */
  public void MPI_Recv(final int[] buf, final int offset, final int count, final int src,
      final int tag, final MPI_Comm comm) throws MPIException {
    final IntBuffer wrapper = IntBuffer.wrap(buf, offset, count);
    final int err = MPILib.INSTANCE.MPI_Recv(
   ...
   * @throws MPIException On MPI error
   */
  public void MPI_Recv(final double[] buf, final int offset, final int count, final int src,
      final int tag, final MPI_Comm comm) throws MPIException {
    final DoubleBuffer wrapper = DoubleBuffer.wrap(buf, offset, count);
    final int err = MPILib.INSTANCE.MPI_Recv(
   ...
   * @throws MPIException On MPI error
   */
  public MPI_Request MPI_Irecv(final double[] buf, final int offset, final int count, final int src,
      final int tag, final MPI_Comm comm) throws MPIException {
    Recv_MPI_Request request = new Recv_MPI_Request(count * 8, buf, offset, count);
    final int err = MPILib.INSTANCE.MPI_Irecv(
   ...
   * @throws MPIException On MPI error
   */
  public MPI_Request MPI_Isend(final double[] buf, final int offset, final int count, final int dst,
      final int tag, final MPI_Comm comm) throws MPIException {
    Send_MPI_Request request = new Send_MPI_Request(count * 8);
    request.buf.write(0, buf, offset, count);
    final int err = MPILib.INSTANCE.MPI_Isend(
