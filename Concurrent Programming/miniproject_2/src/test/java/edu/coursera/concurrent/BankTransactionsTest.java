...
public class BankTransactionsTest extends TestCase {
  ...
  private static long testDriver(final ThreadSafeBankTransaction impl) {
    ...
    assertTrue("Expected total balance before and after simulation to be " + "equal, but was " + preSumOfBalances
  ...
  public void testObjectIsolation() {
    ...
    final String msg = String.format(
        "Expected an improvement of at " + "least %fx with object-based isolation, but saw %fx", expected, improvement);
