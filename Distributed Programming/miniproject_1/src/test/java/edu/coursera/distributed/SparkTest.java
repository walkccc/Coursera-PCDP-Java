...
public class SparkTest extends TestCase {
  private static enum EdgeDistribution { INCREASING, RANDOM, UNIFORM }
  ...
  private static Website generateWebsite(final int i, final int nNodes, final int minEdgesPerNode,
  ...
  private static JavaPairRDD<Integer, Website> generateGraphRDD(final int nNodes,
      final int minEdgesPerNode, final int maxEdgesPerNode, final EdgeDistribution edgeConfig,
  ...
  private static Website[] generateGraphArr(final int nNodes, final int minEdgesPerNode,
      final int maxEdgesPerNode, final EdgeDistribution edgeConfig) {
  ...
  private static void testDriver(final int nNodes, final int minEdgesPerNode,
      final int maxEdgesPerNode, final int niterations, final EdgeDistribution edgeConfig) {
    ...
    System.err.println(getNCores() + "-core execution ran in " + parElapsed
