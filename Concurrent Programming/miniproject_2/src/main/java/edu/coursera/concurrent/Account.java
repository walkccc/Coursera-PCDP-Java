...
public final class Account {
  private int id; // Unique ID number for this account.
  private int balance; // Current balance of this account.
   ...
   * contention. While this work is artificial in this setting, it serves to more
   * accurately simulate real-world conditions where a bank transfer is not a
   * shared-memory operation (i.e., it must contend with network latencies, disk
   * latencies, etc.).
   *
