...
public final class Loader {
  ...
  private static <C extends Component, E extends Edge> void addEdge(final BoruvkaFactory<C, E> factory,
      final Map<IntPair, E> edgesMap, final int from, final int to, final C fromC, final C toC, final double w) {
