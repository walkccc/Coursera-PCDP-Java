...
public class OneDimAveragingPhaserTest extends TestCase {
  ...
  /**
   * A reference implementation of runSequential, in case the one in the main
  ...
  private static void runParallelBarrier(final int iterations, final double[] myNew, final double[] myVal, final int n,
      final int tasks) {
  ...
  public void testFuzzyBarrier() {
    ...
    final String successMsg = String
        .format("Fuzzy barrier parallel implementation " + "ran %fx faster than the barrier implementation", speedup);
